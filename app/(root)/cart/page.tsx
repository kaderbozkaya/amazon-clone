                            ...
                            {itemsPrice < FREE_SHIPPING_MIN_PRICE ? (
                                <div className="flex-1">
                                    ...
                                    <span className='text-green-700'>
                                        <ProductPrice price={FREE_SHIPPING_MIN_PRICE - itemsPrice}
                                        plain
                                        />
                                    </span>
                                    of eligble items to your order to quality for FREE
                                </div>
                            ): (
                                <div className="flex-1">
                                    <span className="text-green-700">Your order qualifies for free shipping
                                    </span>
